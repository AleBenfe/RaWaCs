%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% Demo script for the RaWaCs algorithm. Three demo images with related
% marked regions are provided:
%
% - peppers.mat : classical image of peppers.
% - squares.mat : custom image with concentric red squares.
% - test.mat    : test image with a red square and blue lines on a gray
%                 background
%
...
% Choose the image: the mat files already contains the user marked regions.
load('peppers.mat')
% load('squares.mat')
% load('test.mat')
...
for j1 = 1:length(lab)
    try 
        colbar.TickLabels{j1} = labs{j1};
    catch ME
        if (strcmp(ME.identifier,'MATLAB:undefinedVariable'))
